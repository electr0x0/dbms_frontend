  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('doctor', {
        header: 'Doctor',
        cell: ({ row }) => <Typography>{`${row.original.doctor}`}</Typography>
      }),
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <IconButton>
              <Link href={`apps/appointment/preview/${row.original.id}`} className='flex'>
            ...
            <OptionMenu
              ...
              options={[
                ...
                },
                {
                  ...
                  href: `apps/appointment/edit/${row.original.id}`,
                  linkProps: {
