...
import AddMedicineDrawer from './AddMedicineDrawer'
...
const MedicineListTable = ({ tableData }) => {
  // States
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('batchNumber', {
        header: 'Batch Number',
        cell: ({ row }) => <Typography>{row.original.batchNumber}</Typography>
      }),
      columnHelper.accessor('expiryDate', {
        header: 'Expiry Date',
        cell: ({ row }) => <Typography>{row.original.expiryDate}</Typography>
      }),
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <IconButton>
              <Link href={`apps/medicine/view/${row.original.id}`} className='flex'>
  ...
  return (
    <>
      ...
      <AddMedicineDrawer open={addMedicineOpen} handleClose={() => setAddMedicineOpen(!addMedicineOpen)} />
    </>
  )
}
