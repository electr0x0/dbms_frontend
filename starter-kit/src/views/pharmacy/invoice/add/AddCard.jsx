          ...
          <Grid container spacing={6}>
                ...
                <div className='flex justify-between gap-4 flex-col sm:flex-row'>
                  <div className='flex flex-col gap-6'>
                    <div className='flex items-center gap-2.5'>
                      <a className='tabler-medicine'></a>
                    </div>

                    <div>
                      <Typography color='text.primary'>Pharmacy 149, 450 South Brand Brooklyn</Typography>
                ...
                <div className='flex flex-col gap-4'>
                  ...
                  <div>
                    <div className='flex items-center gap-4'>
                      ...
                      <Typography>${selectData?.total}</Typography>
                    </div>
                    <div className='flex items-center gap-4'>
                ...
                >
                  <Grid container spacing={5} className='m-0 pbe-5'>
                    <Grid item lg={6} md={5} xs={12}>
                      ...
                      <CustomTextField select fullWidth defaultValue='Paracetamol' className='mbe-5'>
                      ...
                      <CustomTextField rows={2} fullWidth multiline defaultValue='Dosage & Instructions' />
                    </Grid>
              ...
              <div className='flex justify-between flex-col gap-4 sm:flex-row'>
                <div className='flex flex-col gap-4 order-2 sm:order-[unset]'>
                  <div className='flex items-center gap-2'>
                    ...
                    <CustomTextField defaultValue='John Doe' />
                  </div>
                  <CustomTextField placeholder='Thank you for your purchase' />
                </div>
            ...
            <Grid item xs={12}>
              ...
              <CustomTextField
                ...
                defaultValue='It was a pleasure serving you. We hope you will visit us again for your pharmaceutical needs. Thank You!'
              />
            </Grid>
          </Grid>
        </CardContent>
