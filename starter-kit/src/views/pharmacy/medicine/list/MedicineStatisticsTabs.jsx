...
// Data for Medicine Statistics Tabs
const tabData = [
  {
    type: 'category',
    avatarIcon: 'tabler-category',
    series: [
      { data: [50, 30, 20, 40, 10] } // Example data representing counts for different categories
    ],
    categories: ['OTC', 'Prescription', 'Vitamins', 'Herbal', 'Other'] // Example categories
  },
  {
    type: 'availability',
    avatarIcon: 'tabler-availability',
    series: [{ data: [70, 30] }], // Example data representing counts for available and unavailable medicines
      ...
      label={
        ...
        >
          ...
          <Typography className='font-medium capitalize' color='text.primary'>
            {item.type === 'category' ? 'Category' : 'Availability'}
          </Typography>
        </div>
      }
    />
...
const MedicineStatisticsTabs = ({ serverMode }) => {
  // States
      ...
      <CardContent>
        <TabContext value={value}>
          <TabList
            ...
            aria-label='medicine statistics tabs'
...
export default MedicineStatisticsTabs
