...
// Vars
const userRoleObj = {
  hospital: { icon: 'tabler-building-hospital', color: 'success' },
  diagnosticcenter: { icon: 'tabler-stethoscope', color: 'success' },
  pharmacy: { icon: 'tabler-pill', color: 'info' }
}
...
const FacilityListTable = ({ tableData }) => {
  // States
