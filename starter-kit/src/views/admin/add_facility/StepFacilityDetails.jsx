...
const facilityTypes = [
  {
    value: 'hospital',
    title: 'Hospital',
    content: <Content>Provide comprehensive healthcare services to patients.</Content>,
    asset: 'tabler-building-hospital',
    isSelected: true
  },
  {
    value: 'pharmacy',
    title: 'Pharmacy',
    content: <Content>Dispense medications and offer pharmaceutical care.</Content>,
    asset: 'tabler-pill'
  },
  {
    value: 'diagnostic-center',
    title: 'Diagnostic Center',
    content: <Content>Offer medical testing and diagnostic services.</Content>,
    asset: 'tabler-dna'
  }
]

const StepFacilityDetails = ({ activeStep, handleNext, handlePrev, steps }) => {
  // Vars
  const initialSelectedOption = facilityTypes.filter(item => item.isSelected)[0].value
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12} md={6}>
        <CustomTextField fullWidth label='Facility Name' placeholder='XYZ Hospital' />
      </Grid>
      <Grid item xs={12} md={6}>
...
export default StepFacilityDetails
