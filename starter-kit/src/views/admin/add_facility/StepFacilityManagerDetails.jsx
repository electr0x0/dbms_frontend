...
const data = [
  {
    ...
    value: 'manager',
    content: 'Upon creation manager user will receive an email with their initial creds',
    asset: 'tabler-building',
    isSelected: true
  }
]

const StepFacilityManagerDetails = ({ activeStep, handleNext, handlePrev, steps }) => {
  // Vars
...
export default StepFacilityManagerDetails
